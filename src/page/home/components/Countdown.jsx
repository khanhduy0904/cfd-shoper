...
export default function Countdown({day, hours, minute, second}) {
    return (
                ...
                <div className="row justify-content-end">
                    <div className="col-12 col-md-8 col-lg-6">
                        ...
                        <div className="d-flex mb-9" data-countdown data-date="Jan 5, 2021 15:37:25">
                            ...
                            <div className="text-center">
                                <div className="font-size-h1 font-weight-bolder text-primary" data-seconds>{second.toString().padStart(2, '0')}</div>
